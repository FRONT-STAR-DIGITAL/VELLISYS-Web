...
function record_site_visit(?string $script = null): void
{
    ...
    if (in_array($script, ['document_pdf.php', 'document_download.php', 'letter_docx.php', 'export.php', 'sw.js', 'offline.html', 'manifest.php', 'push_subscribe.php', 'search_api.php', 'stock_search.php', 'ping.php'], true)) {
        return;
    }
