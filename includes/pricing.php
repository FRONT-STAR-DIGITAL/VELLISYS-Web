...
function pricing_package_defaults(): array
{
    return [
        'solo' => [
            ...
            'was_ugx' => 200000,
            'cta' => 'Select Quill',
            'lead' => 'One login, one location. The books in your colours. Enough for a founder who writes every sheet.',
            'points' => [
        ...
        'studio' => [
            ...
            'was_ugx' => 280000,
            'cta' => 'Select Ledger',
            'lead' => 'The common desk: two seats, access levels, and the full sales loop. Locations cannot outnumber those logins; several people can share a branch.',
            'points' => [
                ...
                'Branches: as many locations as logins (Head office plus named shops). Several logins can sit on one branch',
            ],
            'sort' => 20,
        ],
        'practice' => [
            ...
            'was_ugx' => 350000,
            'cta' => 'Select Crest',
            'lead' => 'Three seats, access levels, and every document the desk can print. Locations cannot outnumber those logins; several people can share a branch.',
            'points' => [
