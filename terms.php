  ...
  <main class="gate-panel">
    ...
    <div class="gate-stack">
      ...
      <div class="gate-box">
        ...
        <h2>Terms</h2>
        <p class="gate-lead">Paying for a package opens a company desk. After payment you choose the email and password you will use to sign in. You are responsible for the documents you issue and for who you add under People.</p>
        <p class="gate-lead">Outgoing mail leaves from the mailbox assigned to the company. Packages, term and expiry sit on the company record. A product of <?= h(product_maker_name()) ?>.</p>
