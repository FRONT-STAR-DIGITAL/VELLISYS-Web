...
<div class="login">
  <section class="login-art">
    <div>
      ...
      <p class="standfirst">Set the letterhead once. Issue quotations, invoices and receipts your clients will keep — in your colour, on your paper.</p>
    </div>
    <p class="login-caption"><?= h($company) ?><?php if ($tag): ?> · <?= h($tag) ?><?php endif; ?></p>
  </section>
  <section class="login-panel">
    <div class="login-still" role="img" aria-label="Letterhead on a desk"></div>
