...
if ((int) $exists['c'] === 0) {
    ...
    if (!$brandRow) {
        $db->query("INSERT INTO branding (company_id, name, tagline, tin, vat_no, address, city, phone, email, website, bank_name, account_name, account_number, brand_color, logo_path, prefix, payment_note, invoice_comments, receipt_comments, plan, currency)
